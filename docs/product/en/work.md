...
**Work ## Refs** accepts only `kind: blueprint`. Domain/Workflow/Stack are indirectly referenced through Blueprint composition (see ADR-0055 Blueprint Composition Template).
