...
> **本目录是 Asset Paper Schema 的 4 个模板**，配合 v0.6.1-alpha.1 分支落地。
...
See [`docs/product/en/asset-templates/`](../../../en/asset-templates/README.html) for English templates.

## 参考

- [Asset Paper Schema · 资产论文结构](../../concepts/asset-paper.md) — 完整论文结构说明
- v0.6.3 Asset Paper Schema RFC 📝 Draft
- ADR-0048 library/external 子目录方案
