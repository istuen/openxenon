          ...
          '/rfc/zh-cn/': [
            {
              ...
              items: [
                ...
                { text: 'OXP-0001 术语精简（已合并入 RFC-0008）', link: '/rfc/zh-cn/OXP-0001-terminology-simplification.html' },
                { text: 'OXP-0002 彻底不判贯彻（已合并入 RFC-0003）', link: '/rfc/zh-cn/OXP-0002-no-judgment-principle.html' },
                { text: 'OXP-0003 Daemon 职责边界（已合并入 RFC-0007）', link: '/rfc/zh-cn/OXP-0003-daemon-responsibility-boundary.html' },
              ],
            },
          ],
        },
