...
> **Insight 是 OXN 的第四结构实体（E4）——整体涌现层**。前三层（Asset + Work + Engine）是还原论的"拆解+验证"，E4 是钱学森系统论整体论的"综合+涌现"。
> Insight 不来源于 Engine 的规则计算，而是来源于 AI 对前三层互动模式的整体推理——**系统整体的功能大于各部分之和（1+1>2）**。

## 1. 哲学定位：钱学森系统论

钱学森系统论的公理：**"整体不可拆分还原，整体涌现 > 各部分简单相加"**。
...
- [Core Concepts](./core-concepts.md) — E1-E4 完整概念 + 钱学森系统论
