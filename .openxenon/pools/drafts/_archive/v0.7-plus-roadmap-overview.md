...
timeline
    ...
    section v0.6.x（2026-07 → 2026-10）最小信任闭环
        v0.6.1 : 信任链就位（三边界 + A1/A2/A3 + 文档）
    section v0.7（2026-11 → 2027-01）信任链效率层
        v0.7.0 : Daemon 完整化 + Insight 自动收集 + Hall v0.5 (Vue)
        v0.7.1 : Insight apply 闭环 + 模式库 + Mermaid 图
        v0.7.2 : Token 经济学 + Hook 框架 + Hall 协同健康度
    section v0.8（2027-02 → 2027-04）信任链外部扩展
