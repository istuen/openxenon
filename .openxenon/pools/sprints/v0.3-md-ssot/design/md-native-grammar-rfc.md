# MD-Native Grammar RFC（v0.3.0 语法改革提案）
...
> **作者**：opencode（与 user 5 轮对话协作，2026-06-23）
> **范围**：3 个子 PR 串行执行，~7 天
...
| D5 | PR 拆分粒度 | 1 大 PR / 2 PR / 3 PR | **A. 3 个串行子 PR**（A: grammar / B: migrate / C: highlight）|
| D6 | v0.3.0 发版策略 | 涵盖 / v0.3.0-rc / 推迟 v0.4 | **A. v0.3.0 涵盖**（发版前完成语法改革）|
