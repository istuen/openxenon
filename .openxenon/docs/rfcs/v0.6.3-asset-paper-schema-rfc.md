...
> **目标版本**：v0.6.3 W9（schema 扩展）+ v0.7.0 W11-12（图渲染）+ v0.7.1（完整版）
> **核心交付**：Asset schema 4 新字段 + library/external 子目录 + 引用计数 + DAG 校验
> **关联讨论**：
>   - [docs_tmp/skill-1.md 反思（奥姆剃刀 + 工作流驱动）](../../../../forges/splits/archive/docs-tmp-era/2026-07-02-harness-3.md)
>   - v0.7.x Memory RFC 反弹记录（[archive/2026-07-05-archive-v0.7.x-memory-rfc-superseded.md](../v0.7-emergence/design/2026-07-05-archive-v0.7.x-memory-rfc-superseded.md)）
