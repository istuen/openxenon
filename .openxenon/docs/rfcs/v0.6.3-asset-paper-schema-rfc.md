...
> **核心交付**：Asset schema 4 新字段 + 引用计数 + DAG 校验（library/external 子目录已由 three-boundary RFC 收敛为 inline，见 ADR-0048 Superseded）
> **关联讨论**：
>   - [docs_tmp/skill-1.md 反思（奥姆剃刀 + 工作流驱动）](../../../../forges/splits/archive/docs-tmp-era/2026-07-02-harness-3.md)
>   - v0.7.x Memory RFC 反弹记录（[archive/2026-07-05-archive-v0.7.x-memory-rfc-superseded.md](../../pools/drafts/_archive/2026-06/2026-07-05-archive-v0.7.x-memory-rfc-superseded.md)）
>   - harness-3.md §Memory 层（信息海关与意图调度，v0.6.3 重新定位为"library 路径"）
...
- [ADR-0048 library/external 子目录方案](../../../../forges/splits/archive/docs-tmp-era/decisions/0048-asset-library-external-scheme.md)
- [ADR-0049 Work/context.md 取代 Memory L1](../../../../forges/splits/archive/docs-tmp-era/decisions/0049-work-context-md-replaces-memory.md)
- [ADR-0050 Onboarding via Starter Work](../../../../forges/splits/archive/docs-tmp-era/decisions/0050-onboarding-via-starter-work.md)
- [ADR-0051 Asset-as-Paper 论文结构 + 引用计数 + DAG](../../../../forges/splits/archive/docs-tmp-era/decisions/0051-asset-paper-citation-network.md)
