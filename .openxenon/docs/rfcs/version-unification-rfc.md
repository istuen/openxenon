...
v0.6.x observability 路线图（`.openxenon/docs/rfcs/v0.6.x-roadmap-rfc.md`，✅ Approved 2026-07-01）规划了 5 个 release：
...
| # | 文档 | 操作 | 状态 |
|---|---|---|---|
| 1 | `.openxenon/docs/rfcs/v0.6.x-roadmap-rfc.md` | 头部标记 Superseded | ✅ 已执行 |
...
- [v0.6.x Roadmap RFC（已被 Superseded）](../../docs/rfcs/v0.6.x-roadmap-rfc.md)
