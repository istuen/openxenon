# v0.6.x 路线图 RFC【SUPERSEDED 2026-07-10】

> **⚠ SUPERSEDED 状态**：本 RFC 于 2026-07-10 经版本统一规划 RFC 废弃。
> **废弃原因**：旧路线图规划 v0.6.1=Daemon+Hall，实际开发走了 Asset 类型体系路线。版本号重映射后可观测性系列移至 v0.6.2~v0.6.6。
> **替代方案**：[版本统一规划 RFC](./version-unification-rfc.md)
> **保留原因**：作为"v0.6.x observability 路线"的完整决策链，供后续可观测性系列参考。

---

# v0.6.x 路线图 RFC（原文） — 可观测性 + Token 经济学 + 涌现雏形
