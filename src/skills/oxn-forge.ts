...
3. 根据意图生成符合 Zod Schema 的 YAML/JSON 结构：
   - Blueprint 示例：
     { "id": "my-blueprint", "name": "我的蓝图", "stages": [...] }
   - Probe 示例：
     { "type": "fs_exists", "pattern": "**/*.json" }
   - Proof 示例：
     { "target": { "description": "..." }, "spec": { "description": "..." }, "probes": [...] }
   - Stage 示例：
     { "id": "my-stage", "name": "我的工序", "deps": [], "proof": {...} }

4. 调用 Core API 将 Draft 资产保存到 DRAFT 目录：
