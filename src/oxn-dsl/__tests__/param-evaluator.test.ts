...
import { createConcretePart, type OxnAssemblyPart, type OxnAssemblyProp } from "../../kernel/schemas/oxn-assembly.schema";
...
describe("validateAbstractParamFields", () => {
  test("字段匹配通过", () => {
    const part = createConcretePart({ name: "jest", props: [
