...
import type { ProjectConfig, SupportedLocale } from '../kernel/processors/project-config'
import { DEFAULT_LOCALE, SUPPORTED_LOCALES } from '../kernel/processors/project-config'
