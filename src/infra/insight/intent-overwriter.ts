...
import { chmodSync, existsSync, readFileSync, writeFileSync } from '../filesystem'
import { IAPError, IAPAction, type ApprovalRecord, type ImprovementSuggestionMeta } from '../../kernel/index'
