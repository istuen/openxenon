...
import type { FrozenBlueprint, FrozenPart, FrozenProbe } from '@openxenon/engine/kernel/index'
import { createXenonMeta, validateFrozenBlueprint } from '@openxenon/engine/kernel/index'
