...
- **THEN** AI SHALL 输出 "已生成 Draft 资产，等待审查。请使用 `oxn arsenal inspect` 查看内容，确认后使用 `oxn arsenal promote` 转正。"

#### Scenario: 工程师 promote 资产
- **WHEN** 工程师执行 `oxn arsenal promote <asset-path>`
